...
## IPA上传文件助手v1.0.2（Mac、Windows）版本，[下载IPA上传助手Mac](https://raw.githubusercontent.com/netyouli/WHC_ConfuseSoftware/master/IPA上传助手-mac-1.0.2.app.7z)、[下载IPA上传助手Windows](https://raw.githubusercontent.com/netyouli/WHC_ConfuseSoftware/master/IPA上传助手-win-1.0.2.app.7z),解决电脑关联导致各种审核问题(other, 4.3, 2.3.1, 封号等)
