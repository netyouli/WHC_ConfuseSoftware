...
### v1.9.9.5.9.6
    1.修复kt混淆特殊语法卡死问题
    2.修复oc高级模式拆分函数运行出现死循环问题
    3.其他问题修复

### v1.9.9.5.9.5
    1.优化c/c++高级模式混淆函数名
    2.优化oc高级模式拆分函数功能
    3.修复c/c++高级模式旧垃圾代码报错问题
    4.修复kotlin嵌套注释解析错误的问题
    5.修复kotlin代码解析错误的问题
    6.修复kotlin代码混淆编译错误的问题
    7.其他问题修复

### v1.9.9.5.9.4
    1.优化cpp插入垃圾属性避免宏的class插入
    2.优化cpp宏body插入垃圾代码形式
    3.优化android的.9图片同步混淆
    4.优化android的id混淆binding问题
    5.优化c/c++高级模式混淆函数名，属性功能
    6.添加c/c++高级模式插入垃圾函数，垃圾属性，打乱调用顺序功能

### v1.9.9.5.9.3
    1.修复精准模式oc混淆类名偶现的错误bug
    2.修复精准模式混淆oc函数局部变量有些遗漏的bug
    3.优化c++高级模式混淆
    4.其他问题优化

### v1.9.9.5.9.2
    1.修复ios混淆出现卡死问题
    2.优化swift的Codable模型插入属性类型
    3.修复优化oc高级模式拆分函数编译错误的问题

### v1.9.9.5.9.1
    1.修复高级模式oc(函数，属性，垃圾代码插入)混淆一些问题
    2.其他问题优化

### v1.9.9.5.9.0
    1.修复高级模式oc混淆崩溃问题
    2.修复精准模式混淆局部变量修改错误问题
    3.修复android插入垃圾UI导致异常问题
    4.修复高级模式混淆import修改错误的问题
    5.优化kt垃圾代码
    6.优化flutter代码混淆，修复一些混淆编译错误问题

### v1.9.9.5.8.9
    1.修复oc高级模式函数拆分bug
    2.优化android的res资源引用混淆
    3.修复未勾选flutter项目混淆dart时不插入math的import
    4.修复oc高级模式融合block变量到垃圾代码调用错误的问题
    5.修复sks节点name重复混淆的问题

### v1.9.9.5.8.8
    1.修复混淆ios项目的sks文件崩溃问题
    2.添加android项目混淆资源id可配置混淆代码相同名称的字符串功能
    3.添加手动c/c++字符串加解密功能
    4.修复c++函数名称混淆错误问题
    5.修复c++属性名称混淆漏的问题
    6.其他问题修复
...
### v1.9.9.5.8.6
    1.修复c#解析代码语法闪退问题
    2.修复c#混淆崩溃问题
    3.修复高级模式混淆oc拆分函数编译报错问题
    4.修复混淆sks文件里面节点丢失日志的问题
    5.其他问题修复

### v1.9.9.5.8.5
    1.修复高级模式一些oc拆分函数bug
    2.修复oc，c，c++垃圾代码release模式崩溃问题
    3.修复android生成UI代码影响原有UI的问题
    4.其他问题修复
...
### v1.9.9.5.8.1
    1.修复oc高级模式混淆属性函数编译错误问题
    2.其他问题修复

### v1.9.9.5.8.0
    1.修复oc高级模式混淆属性函数编译错误问题
    2.修复c#混淆函数名称和类名一致编译错误问题
    3.其他问题修复
...
### v1.9.9.5.7.6
    1.新作oc代码高级混淆模式
    2.支持拆分oc函数成多个子函数
    3.支持混淆oc全局变量，全局函数，函数参数名称
    4.修复uniapp注释清理bug
    5.其他问题修复

### v1.9.9.5.7.5
    1.优化swift枚举混淆，修复一些错误
    2.优化swift垃圾代码插入，修复一些错误
    3.其他问题修复

### v1.9.9.5.7.4
    1.修复混淆c#特殊语法崩溃的情况
    2.优化oc的jsonmodel属性插入
    3.其他问题修复

### v1.9.9.5.7.3
    1.修复oc，c，c++特殊情况垃圾代码在release模式crash的bug
    2.修复属性，根据设置前缀自动调整特殊情况无效问题
    3.其他问题修复

### v1.9.9.5.7.2
    1.优化属性，类名，代码文件生成方式，根据设置前缀自动调整
    2.其他问题修复
...
### v1.9.9.5.6.7
    1.优化flutter全局属性混淆
    2.修复lua特殊语法识别错误导致卡死问题
    3.其他问题的修复

###  v1.9.9.5.6.6
    1.优化rn项目的jsx，tsx函数名混淆
    2.优化oc class名称混淆
    3.其他问题修复

### v1.9.9.5.6.5
    1.优化uniapp，rn 函数名混淆，修复mome漏改的情况
    2.修复rn组件名称小写的问题
    3.修复vue函数名称误混淆问题
    4.优化vue布局html代码解析
    5.优化oc函数里面局部变量名称的混淆
...
### v1.9.9.5.6.4
    1.优化android项目克隆，修复xml引入代码路径错误问题
    2.优化kotlin代码解析
    3.修复kotlin代码混淆编译错误的问题
    4.优化oc属性混淆
    5.优化oc局部变量名称混淆
    6.其他问题修复
